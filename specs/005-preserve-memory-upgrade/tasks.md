...
- [x] T005 [US1] Call `detect_provisioned_agents()` after CLI upgrade in `specify-run`
...
- [x] T013 [US2] Manual test: modify `.specify/scripts/bash/common.sh`, upgrade, verify replaced (deferred to T020)
