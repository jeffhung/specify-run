...
- [x] T016 [US2] Add version pinning security benefits to SECURITY.md
...
- [x] T020 [US3] Add CI troubleshooting section to INTEGRATION.md
...
- [x] T028 Review SECURITY.md for completeness
